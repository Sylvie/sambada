...
#ifndef SAMBADA_FLOTSORTIEFICHIERFACTORY_HPP
#define SAMBADA_FLOTSORTIEFICHIERFACTORY_HPP

#include "FlotSortieFactory.hpp"

namespace  sambada {

	class FlotSortieFichierFactory : public FlotSortieFactory
	{
	public:
...
#endif //SAMBADA_FLOTSORTIEFICHIERFACTORY_HPP
