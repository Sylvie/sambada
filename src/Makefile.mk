...
include src/parametres/Makefile.mk
...
## Cleaning ##
clean-local-src: clean-local-src-common clean-local-src-histograms clean-local-src-modeles clean-local-src-parametres clean-local-src-variables
