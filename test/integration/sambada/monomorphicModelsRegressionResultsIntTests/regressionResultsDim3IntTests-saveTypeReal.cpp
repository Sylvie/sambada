...
SCENARIO("Test that regression results for monomophic models are correct for models of dimension 3 with SAVETYPE REAL", "[monomorphic-models-dim-3-savetype-real-int][monomorphic-models-int]") {
    ...
    GIVEN("A program to run, its expected output file, and the file of expected results")
    {
        ...
        std::string fileNameParam(pathToInputFolder + "param-dim-3-savetype-real.txt");
