...
SCENARIO("Test that regression results for monomophic models are correct for models of dimension 3 when the marker is absent in all locations", "[monomorphic-models-dim-3-marqueur-absent-int][monomorphic-models-int]") {
