...
EXTRA_DIST += \
		...
		$(top_srcdir)/test/integration/sambada/wrongNumberOfIndividualsIntTests/choice-mark-cattle-too-many-individuals.csv.txt \
		$(top_srcdir)/test/integration/sambada/wrongNumberOfIndividualsIntTests/choice-mark-cattle-too-few-individuals.csv.txt \
