...
EXTRA_DIST += \
		...
		$(top_srcdir)/test/integration/sambada/basicPopulationStructureIntTests/trivariateModelsReal/expected-results-pop-first-dim-1.txt \
		...
		$(top_srcdir)/test/integration/sambada/basicPopulationStructureIntTests/trivariateModelsReal/expected-results-pop-last-dim-2.txt \
