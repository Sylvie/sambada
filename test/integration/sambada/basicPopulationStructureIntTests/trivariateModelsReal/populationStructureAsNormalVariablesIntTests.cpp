...
SCENARIO("Test that regression results are correct with \"SAVETYPE REAL\" when the population structure is considered as a normal environmental variable",
         "[pop-struct-as-normal-env-var-real-int][pop-struct-int]") {
