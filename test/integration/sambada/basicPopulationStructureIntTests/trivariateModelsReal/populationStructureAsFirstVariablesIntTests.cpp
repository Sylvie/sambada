...
SCENARIO("Test that regression results are correct with \"SAVETYPE REAL\" when the population structure is placed before the environmental variables",
         "[pop-struct-as-first-var-real-int][pop-struct-int]") {
