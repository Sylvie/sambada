...
SCENARIO("Test that Storey's p-values histograms are correct with score threshold, population structure as last variables, and \"SAVETYPE END\"",
		"[storey-histograms-with-score-threshold-pop-structure-as-last-variables-savetype-end-int][storey-histograms-threshold-int]") {
