...
EXTRA_DIST += \
		...
		$(top_srcdir)/test/integration/sambada/splitInputFilesIntTests/choice-mark-cattle-mark-0-0 \
		$(top_srcdir)/test/integration/sambada/splitInputFilesIntTests/choice-mark-cattle-mark-1-3.txt \
		$(top_srcdir)/test/integration/sambada/splitInputFilesIntTests/choice-mark-cattle-mark-1-3 \
