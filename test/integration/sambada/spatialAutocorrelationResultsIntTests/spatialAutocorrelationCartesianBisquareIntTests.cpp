...
SCENARIO("Test that spatial autocorrelation is computed correctly for cartesian coordinates and bisquare weighting",
         "[spatial-autocorrelation-cartesian-bisquare-int]") {
    ...
    GIVEN("Some input files with sampling locations")
    {
        ...
        std::string fileNameExpectedResultsASEnv(pathToInputFolder + "expected-results-cartesian-bisquare-env.txt");
        std::string fileNameExpectedResultsASEnvPVal(pathToInputFolder + "expected-results-cartesian-bisquare-env-pval.txt");
        std::string fileNameExpectedResultsASMark(pathToInputFolder + "expected-results-cartesian-bisquare-mark.txt");
        std::string fileNameExpectedResultsASMarkPVal(pathToInputFolder + "expected-results-cartesian-bisquare-mark-pval.txt");
