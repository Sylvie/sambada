...
SCENARIO("Test that spatial autocorrelation is computed correctly for spherical coordinates and distance weighting",
         "[spatial-autocorrelation-spherical-distance-int]") {
    ...
    GIVEN("Some input files with sampling locations")
    {
        ...
        std::string fileNameParams(pathToInputFolder + "param-spherical-distance.txt");
        ...
        std::string fileNameExpectedResultsASEnv(pathToInputFolder + "expected-results-spherical-distance-env.txt");
        std::string fileNameExpectedResultsASEnvPVal(pathToInputFolder + "expected-results-spherical-distance-env-pval.txt");
        std::string fileNameExpectedResultsASMark(pathToInputFolder + "expected-results-spherical-distance-mark.txt");
        std::string fileNameExpectedResultsASMarkPVal(pathToInputFolder + "expected-results-spherical-distance-mark-pval.txt");
