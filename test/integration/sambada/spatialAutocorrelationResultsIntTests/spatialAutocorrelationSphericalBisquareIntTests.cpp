...
SCENARIO("Test that spatial autocorrelation is computed correctly for spherical coordinates and bisquare weighting",
         "[spatial-autocorrelation-spherical-bisquare-int]") {
    ...
    GIVEN("Some input files with sampling locations")
    {
        ...
        std::string fileNameParams(pathToInputFolder + "param-spherical-bisquare.txt");
        ...
        std::string fileNameExpectedResultsASEnv(pathToInputFolder + "expected-results-spherical-bisquare-env.txt");
        std::string fileNameExpectedResultsASEnvPVal(pathToInputFolder + "expected-results-spherical-bisquare-env-pval.txt");
        std::string fileNameExpectedResultsASMark(pathToInputFolder + "expected-results-spherical-bisquare-mark.txt");
        std::string fileNameExpectedResultsASMarkPVal(pathToInputFolder + "expected-results-spherical-bisquare-mark-pval.txt");
