...
SCENARIO("Test that spatial autocorrelation is computed correctly for cartesian coordinates and distance weighting",
         "[spatial-autocorrelation-cartesian-distance-int]") {
    ...
    GIVEN("Some input files with sampling locations")
    {
        ...
        std::string fileNameParams(pathToInputFolder + "param-cartesian-distance.txt");
        ...
        std::string fileNameExpectedResultsASEnv(pathToInputFolder + "expected-results-cartesian-distance-env.txt");
        std::string fileNameExpectedResultsASEnvPVal(pathToInputFolder + "expected-results-cartesian-distance-env-pval.txt");
        std::string fileNameExpectedResultsASMark(pathToInputFolder + "expected-results-cartesian-distance-mark.txt");
        std::string fileNameExpectedResultsASMarkPVal(pathToInputFolder + "expected-results-cartesian-distance-mark-pval.txt");
