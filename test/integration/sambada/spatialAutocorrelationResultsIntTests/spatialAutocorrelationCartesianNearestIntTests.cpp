...
SCENARIO("Test that spatial autocorrelation is computed correctly for cartesian coordinates and nearest neighbours weighting",
         "[spatial-autocorrelation-cartesian-nearest-int]") {
    ...
    GIVEN("Some input files with sampling locations")
    {
        ...
        std::string fileNameExpectedResultsASEnv(pathToInputFolder + "expected-results-cartesian-nearest-env.txt");
        std::string fileNameExpectedResultsASEnvPVal(pathToInputFolder + "expected-results-cartesian-nearest-env-pval.txt");
        std::string fileNameExpectedResultsASMark(pathToInputFolder + "expected-results-cartesian-nearest-mark.txt");
        std::string fileNameExpectedResultsASMarkPVal(pathToInputFolder + "expected-results-cartesian-nearest-mark-pval.txt");
