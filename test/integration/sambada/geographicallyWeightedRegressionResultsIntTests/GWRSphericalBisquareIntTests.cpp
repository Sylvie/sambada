...
SCENARIO("Test that geographically weighted regression is computed correctly for spherical coordinates and \"bisquare\" weighting ",
         "[gwr-spherical-bisquare-int][gwr-int]")
{
	...
	GIVEN("Some input files with geolocated samples")
	{
		...
		std::string fileNameExpectedResultsDim1(pathToInputFolder + "expected-results-spherical-bisquare-dim-1.txt");
		std::string fileNameExpectedResultsDim2(pathToInputFolder + "expected-results-spherical-bisquare-dim-2.txt");
