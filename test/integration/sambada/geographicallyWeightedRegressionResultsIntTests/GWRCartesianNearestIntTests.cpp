...
SCENARIO("Test that geographically weighted regression is computed correctly for cartesian coordinates and \"nearest\" weighting ",
         "[gwr-cartesian-nearest-int][gwr-int]")
{
	...
	GIVEN("Some input files with geolocated samples")
	{
		...
		std::string fileNameExpectedResultsDim1(pathToInputFolder + "expected-results-cartesian-nearest-dim-1.txt");
		std::string fileNameExpectedResultsDim2(pathToInputFolder + "expected-results-cartesian-nearest-dim-2.txt");
