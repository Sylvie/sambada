...
SCENARIO("Test that geographically weighted regression is computed correctly for spherical coordinates and \"nearest\" weighting ",
         "[gwr-spherical-nearest-int][gwr-int]")
{
	...
	GIVEN("Some input files with geolocated samples")
	{
		...
		std::string fileNameExpectedResultsDim1(pathToInputFolder + "expected-results-spherical-nearest-dim-1.txt");
		std::string fileNameExpectedResultsDim2(pathToInputFolder + "expected-results-spherical-nearest-dim-2.txt");
