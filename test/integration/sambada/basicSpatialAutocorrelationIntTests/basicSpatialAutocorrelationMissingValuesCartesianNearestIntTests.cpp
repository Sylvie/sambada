...
SCENARIO("Test that spatial autocorrelation is computed correctly with some missing environmental data with cartesian coordinates and \"nearest\" weighting",
         "[basic-spatial-autocorrelation-missing-values-cartesian-nearest-int]") {
    ...
    GIVEN("Some input files with sampling locations")
    {
        ...
        std::string fileNameParams(pathToInputFolder + "param-random-sample-missing-values-nearest.txt");
        std::string fileNameData(pathToInputFolder + "random-sample-missing-values.txt");

        std::string fileNameExpectedResultsASEnv(pathToInputFolder + "expected-results-random-sample-missing-values-nearest-AS-Env.txt");
        std::string fileNameExpectedResultsASEnvPVal(pathToInputFolder + "expected-results-random-sample-missing-values-nearest-AS-Env-pVal.txt");
