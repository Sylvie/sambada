...
EXTRA_DIST += \
 		...
 		$(top_srcdir)/test/integration/sambada/resultFilesLocationIntTests/choice-env-cattle \
		$(top_srcdir)/test/integration/sambada/resultFilesLocationIntTests/choice-mark-cattle.txt \
		$(top_srcdir)/test/integration/sambada/resultFilesLocationIntTests/choice-mark-cattle \
		$(top_srcdir)/test/integration/sambada/resultFilesLocationIntTests/choice-data-cattle.csv \
		$(top_srcdir)/test/integration/sambada/resultFilesLocationIntTests/choice-data-cattle \
