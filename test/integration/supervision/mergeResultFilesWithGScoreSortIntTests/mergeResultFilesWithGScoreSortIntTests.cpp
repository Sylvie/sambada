...
SCENARIO("Test that Supervision merges results correctly with a G score sort",
         "[merge-result-files-G-score-sort-int]") {
    ...
    GIVEN("Some result files from Sambada")
    {
        ...
        std::string pathToTestFolder("test/integration/supervision/mergeResultFilesWithGScoreSortIntTests/");
        ...
        std::string fileNameExpectedResultsDim1(pathToInputFolder + "expected-results-G-sort-dim-1.txt");
        std::string fileNameExpectedResultsDim2(pathToInputFolder + "expected-results-G-sort-dim-2.txt");
        std::string fileNameExpectedResultsDim3(pathToInputFolder + "expected-results-G-sort-dim-3.txt");
