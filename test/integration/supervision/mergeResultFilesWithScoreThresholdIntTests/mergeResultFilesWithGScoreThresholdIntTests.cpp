...
SCENARIO("Test that Supervision merges results correctly with a G score threshold",
         "[merge-result-files-G-score-threshold-int]") {
    ...
    GIVEN("Some result files from Sambada")
    {
        ...
        std::string fileNameExpectedResultsDim1(pathToInputFolder + "expected-results-G-dim-1.txt");
        std::string fileNameExpectedResultsDim2(pathToInputFolder + "expected-results-G-dim-2.txt");
        std::string fileNameExpectedResultsDim3(pathToInputFolder + "expected-results-G-dim-3.txt");
        ...
        lecteurCorrige.close();
        expectedResultsDim1.verifieTailles(true, 1, 118);
        ...
        lecteurCorrige.close();
        expectedResultsDim2.verifieTailles(true, 2, 49);
        ...
        lecteurCorrige.close();
        expectedResultsDim3.verifieTailles(true, 3, 12);
