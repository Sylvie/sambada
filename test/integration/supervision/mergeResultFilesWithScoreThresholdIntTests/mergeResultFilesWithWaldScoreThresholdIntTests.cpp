...
SCENARIO("Test that Supervision merges results correctly with a Wald score threshold",
         "[merge-result-files-Wald-score-threshold-int]") {
    ...
    GIVEN("Some result files from Sambada")
    {
        ...
        std::string scoreThresholdType = "Wald";
        ...
        std::string fileNameExpectedResultsDim1(pathToInputFolder + "expected-results-Wald-dim-1.txt");
        std::string fileNameExpectedResultsDim2(pathToInputFolder + "expected-results-Wald-dim-2.txt");
        std::string fileNameExpectedResultsDim3(pathToInputFolder + "expected-results-Wald-dim-3.txt");
        ...
        lecteurCorrige.close();
        expectedResultsDim1.verifieTailles(true, 1, 115);
        ...
        lecteurCorrige.close();
        expectedResultsDim2.verifieTailles(true, 2, 31);
        ...
        lecteurCorrige.close();
        expectedResultsDim3.verifieTailles(true, 3, 6);
